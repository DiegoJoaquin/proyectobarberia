...
async function run() {
  const { data, error } = await supabase.from('bookings').select('id, name, status, notes').filter('notes', 'ilike', '%1231c64cbbe4b5c5b5ef1319d00a79da4f0efc27e4b18c15f806e678e5fce404%');
